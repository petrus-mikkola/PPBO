...
stderr eZ,0.4618,0.01,3,INV_GAMMA_PDF,0.413,2; %alpha = (beta+mean)/mean, and mean=.413    
%OLD CODE: stderr eZ,0.4618,0.01,3,INV_GAMMA_PDF,0.1,2;
...
rhoZ,.9676 ,.01,.9999,BETA_PDF,0.95,0.20;
rhog,.9930,.01,.9999,BETA_PDF,0.957,0.20;
rhob2,.2703,.01,.9999,BETA_PDF,0.899,0.20;
rhomu,.5724,.01,.9999,BETA_PDF,0.749,0.20;
rhoms,.3,.01,.9999,BETA_PDF,0.474,0.20;
rhop,.8692,.01,.9999,BETA_PDF,0.762,0.20;
rhow,.9546,.001,.9999,BETA_PDF,0.69,0.20;
thetap,.7652,0.01,.9999,BETA_PDF,param2,0.2;
thetaw,.8936,0.01,.9999,BETA_PDF,param3,0.2;
inv_adj_cost,6.3325,2,15,NORMAL_PDF,param4,1.5;
sigma_c,1.2312,0.25,3,NORMAL_PDF,param5,0.375;
...
nu_L,2.8401,0.25,10,NORMAL_PDF,1.489,0.75;
zeta_p,0.7813,0.5,0.95,BETA_PDF,param1,0.10;
iota_w,0.4425,0.01,0.99,BETA_PDF,0.438,0.15;
iota_p,0.3291,0.01,0.99,BETA_PDF,0.245,0.15;
czcap,0.2648,0.01,1,BETA_PDF,0.899,0.15;
Phi,1.4672,1.0,3,NORMAL_PDF,1.45,0.125;
psi1,1.7985,1.0,3,NORMAL_PDF,1.682,0.25;
rhoR,0.8258,0.5,0.975,BETA_PDF,0.879,0.10;
psi2,0.0893,0.001,0.5,NORMAL_PDF,0.108,0.05;
psi3,0.2239,0.001,0.5,NORMAL_PDF,0.152,0.05;
const_pi,0.7,0.1,2.0,GAMMA_PDF,0.625,0.1;
constebeta,0.7420,0.01,2.0,GAMMA_PDF,0.247,0.1;
const_L,1.2918,-10.0,10.0,NORMAL_PDF,0.34,2.0;
ctrend,0.3982,0.1,0.8,NORMAL_PDF,0.405,0.10;
rhogZ,0.05,0.01,2.0,NORMAL_PDF,0.492,0.25;
alpha,0.24,0.01,1.0,NORMAL_PDF,0.213,0.05;
...
irf_dy_eZ =cell2mat(oo_.prior_function_results(:,1));
irf_dc_eZ =cell2mat(oo_.prior_function_results(:,2));
irf_labobs_eZ =cell2mat(oo_.prior_function_results(:,3));
irf_dw_eZ =cell2mat(oo_.prior_function_results(:,4));
